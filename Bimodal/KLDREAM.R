...
setwd("/project/quinnlab/hk3sku/MCMC/bimodal/Post-DreamNew")

true <- read.table("/project/quinnlab/hk3sku/MCMC/bimodal/sampledreambimodal.txt") 
...
outputFile <- paste("/project/quinnlab/hk3sku/MCMC/bimodal/KLDreamNew/KL", k,  ".Rdata",sep="")
