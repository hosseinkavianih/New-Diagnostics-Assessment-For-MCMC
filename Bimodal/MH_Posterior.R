...
setwd("/gpfs/gpfs0/project/quinnlab/hk3sku/MCMC/bimodal/MHNew")
...
outputFile <- paste("/gpfs/gpfs0/project/quinnlab/hk3sku/MCMC/bimodal/Post-MHNew/Posterior", j,  ".Rdata",sep="")
