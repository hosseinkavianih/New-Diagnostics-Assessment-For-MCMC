...
setwd("/sfs/lustre/bahamut/scratch/hk3sku/MCMC/200d/DREAMpost/")

true <- read.table("/sfs/lustre/bahamut/scratch/hk3sku/MCMC/200d/sampleDREAM2.txt") 
...
outputFile <- paste("/sfs/lustre/bahamut/scratch/hk3sku/MCMC/200d/KLDREAM2/KL", k,  ".Rdata",sep="")
