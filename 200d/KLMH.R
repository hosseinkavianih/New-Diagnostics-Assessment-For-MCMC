...
setwd("/sfs/lustre/bahamut/scratch/hk3sku/MCMC/200d/MHpost2/")

true <- read.table("/sfs/lustre/bahamut/scratch/hk3sku/MCMC/200d/sampleMH.txt") 
...
outputFile <- paste("/sfs/lustre/bahamut/scratch/hk3sku/MCMC/200d/KLMH2/KL", k,  ".Rdata",sep="")
