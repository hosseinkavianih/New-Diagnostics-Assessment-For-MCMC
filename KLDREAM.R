...
setwd("/scratch/hk3sku/MCMC/HYMOD/outdreamnewwithoutupdate")
    ...
    if (length(lofparam) > 0) {
     ...
     for (i in 1:length(lofparam)) {
      ...
      # Calculating posterior matrix for each LH and random seed
       ...
       Posterior <- paste("/scratch/hk3sku/MCMC/HYMOD/PosteriorDreamWithhout/Posterior", "Seed", i, "Param", j, ".Rdata",sep="")
