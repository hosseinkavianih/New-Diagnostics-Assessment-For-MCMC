...
true <- read.table("/scratch/hk3sku/MCMC/HYMOD/samplesmcbimodal.txt") 

setwd("/scratch/hk3sku/MCMC/HYMOD/PosteriorSMC")
...
outputFile <- paste("/scratch/hk3sku/MCMC/HYMOD/KLSMC/KL", k,  ".Rdata",sep="")
